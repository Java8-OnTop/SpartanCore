...
import me.xss6.SpartanProtect.motd.RandomMOTD;
...
public class ServerPingListener implements Listener
{
    ...
    public void a(final ServerListPingEvent event) {
        if (Bukkit.getServer().hasWhitelist()) {
            final List<String> whitelistList = (List<String>)RandomMOTD.Instance.getConfig().getStringList("Settings.WhitelistMOTDS");
            ...
            final List<String> list = (List<String>)RandomMOTD.Instance.getConfig().getStringList("Settings.MOTDS");
